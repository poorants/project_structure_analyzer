...
void getSourceWithDirectory(
    List<SourceModel> sourceList, String targetDirectory,
  ...
  for (FileSystemEntity entity in entities) {
    ...
    // If it's a directory
      ...
      // Call it recursively.
      getSourceWithDirectory(sourceList, entity.path);
    }
  }
}
...
String getBetterThenIncludePath(
    ...
    String extention,
    SourceModel source) {
  // List<SourceModel> targetList =
  //     _getSourceListByNameWithExtention(sourceList, name, extention);
